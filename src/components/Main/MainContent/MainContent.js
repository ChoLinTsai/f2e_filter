...
export default class MainContent extends Component {
      ...
      stores: [
        {
          ...
          name: "Ethan Foster",
          detail:
            "Donec euismod scelerisque ligula. Maecenas eu varius risus, eu aliquet arcu. Curabitur fermentum suscipit est, tincidunt mattis lorem luctus id.",
        ...
        },
        {
          ...
          name: "Herman Cobb",
          detail:
            "It was a humorously perilous business for both of us. For, before we proceed further, it must be said that the monkey-rope was fast at both ends.",
          location: "Kaohsiung City",
          tags: "Entertainment",
  ...
  render() {
    ...
    const mainContent = this.state.stores.map(i => {
      return (
        <div key={i.id} className="col s12">
    ...
    return <section className="mainContentBlock">{mainContent}</section>;
  }
}
